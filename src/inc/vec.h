...
#define vec_total_size(vec) (sizeof(_vector_header) + (vec)->capacity * sizeof(seq_elem_type(vec)))
...
static inline _vector_header *
_new_vec(_vector_header *header, usize initial_size)
{
    header->count    = 0;
