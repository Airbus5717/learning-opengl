/*
    ...
    OpenGL loader generated by glad 0.1.36 on Sat Apr 29 19:33:08 2023.
...
static void
load_GL_AMD_draw_buffers_blend(GLADloadproc load)
{
...
static void
load_GL_AMD_framebuffer_multisample_advanced(GLADloadproc load)
{
...
static void
load_GL_AMD_framebuffer_sample_positions(GLADloadproc load)
{
...
static void
load_GL_AMD_gpu_shader_int64(GLADloadproc load)
{
...
static void
load_GL_AMD_interleaved_elements(GLADloadproc load)
{
...
static void
load_GL_AMD_multi_draw_indirect(GLADloadproc load)
{
...
static void
load_GL_AMD_name_gen_delete(GLADloadproc load)
{
...
static void
load_GL_AMD_occlusion_query_event(GLADloadproc load)
{
...
static void
load_GL_AMD_performance_monitor(GLADloadproc load)
{
...
static void
load_GL_AMD_stencil_operation_extended(GLADloadproc load)
{
...
static void
load_GL_AMD_vertex_shader_tessellator(GLADloadproc load)
{
...
static void
load_GL_APPLE_element_array(GLADloadproc load)
{
...
static void
load_GL_APPLE_fence(GLADloadproc load)
{
...
static void
load_GL_APPLE_flush_buffer_range(GLADloadproc load)
{
...
static void
load_GL_APPLE_object_purgeable(GLADloadproc load)
{
...
static void
load_GL_APPLE_texture_range(GLADloadproc load)
{
...
static void
load_GL_APPLE_vertex_array_object(GLADloadproc load)
{
...
static void
load_GL_APPLE_vertex_array_range(GLADloadproc load)
{
...
static void
load_GL_APPLE_vertex_program_evaluators(GLADloadproc load)
{
...
static void
load_GL_ARB_ES2_compatibility(GLADloadproc load)
{
...
static void
load_GL_ARB_ES3_1_compatibility(GLADloadproc load)
{
    if (!GLAD_GL_ARB_ES3_1_compatibility) return;
    glad_glMemoryBarrierByRegion = (PFNGLMEMORYBARRIERBYREGIONPROC)load("glMemoryBarrierByRegion");
}
static void
load_GL_ARB_ES3_2_compatibility(GLADloadproc load)
{
...
static void
load_GL_ARB_base_instance(GLADloadproc load)
{
...
static void
load_GL_ARB_bindless_texture(GLADloadproc load)
{
...
static void
load_GL_ARB_blend_func_extended(GLADloadproc load)
{
...
static void
load_GL_ARB_buffer_storage(GLADloadproc load)
{
    if (!GLAD_GL_ARB_buffer_storage) return;
    glad_glBufferStorage = (PFNGLBUFFERSTORAGEPROC)load("glBufferStorage");
}
static void
load_GL_ARB_cl_event(GLADloadproc load)
{
...
static void
load_GL_ARB_clear_buffer_object(GLADloadproc load)
{
...
static void
load_GL_ARB_clear_texture(GLADloadproc load)
{
...
static void
load_GL_ARB_compute_variable_group_size(GLADloadproc load)
{
...
static void
load_GL_ARB_direct_state_access(GLADloadproc load)
{
...
static void
load_GL_ARB_draw_elements_base_vertex(GLADloadproc load)
{
...
static void
load_GL_ARB_draw_indirect(GLADloadproc load)
{
...
static void
load_GL_ARB_draw_instanced(GLADloadproc load)
{
...
static void
load_GL_ARB_fragment_program(GLADloadproc load)
{
...
static void
load_GL_ARB_framebuffer_no_attachments(GLADloadproc load)
{
...
static void
load_GL_ARB_framebuffer_object(GLADloadproc load)
{
...
static void
load_GL_ARB_geometry_shader4(GLADloadproc load)
{
...
static void
load_GL_ARB_get_program_binary(GLADloadproc load)
{
...
static void
load_GL_ARB_get_texture_sub_image(GLADloadproc load)
{
...
static void
load_GL_ARB_gpu_shader_int64(GLADloadproc load)
{
...
static void
load_GL_ARB_imaging(GLADloadproc load)
{
...
static void
load_GL_ARB_indirect_parameters(GLADloadproc load)
{
...
static void
load_GL_ARB_instanced_arrays(GLADloadproc load)
{
...
static void
load_GL_ARB_internalformat_query(GLADloadproc load)
{
    if (!GLAD_GL_ARB_internalformat_query) return;
    glad_glGetInternalformativ = (PFNGLGETINTERNALFORMATIVPROC)load("glGetInternalformativ");
}
static void
load_GL_ARB_internalformat_query2(GLADloadproc load)
{
...
static void
load_GL_ARB_invalidate_subdata(GLADloadproc load)
{
...
static void
load_GL_ARB_map_buffer_range(GLADloadproc load)
{
...
static void
load_GL_ARB_matrix_palette(GLADloadproc load)
{
...
static void
load_GL_ARB_multi_bind(GLADloadproc load)
{
...
static void
load_GL_ARB_multi_draw_indirect(GLADloadproc load)
{
...
static void
load_GL_ARB_occlusion_query(GLADloadproc load)
{
...
static void
load_GL_ARB_parallel_shader_compile(GLADloadproc load)
{
...
static void
load_GL_ARB_point_parameters(GLADloadproc load)
{
...
static void
load_GL_ARB_polygon_offset_clamp(GLADloadproc load)
{
...
static void
load_GL_ARB_program_interface_query(GLADloadproc load)
{
...
static void
load_GL_ARB_provoking_vertex(GLADloadproc load)
{
    if (!GLAD_GL_ARB_provoking_vertex) return;
    glad_glProvokingVertex = (PFNGLPROVOKINGVERTEXPROC)load("glProvokingVertex");
}
static void
load_GL_ARB_robustness(GLADloadproc load)
{
...
static void
load_GL_ARB_sample_locations(GLADloadproc load)
{
...
static void
load_GL_ARB_separate_shader_objects(GLADloadproc load)
{
...
static void
load_GL_ARB_shader_atomic_counters(GLADloadproc load)
{
...
static void
load_GL_ARB_shader_image_load_store(GLADloadproc load)
{
...
static void
load_GL_ARB_shader_objects(GLADloadproc load)
{
...
static void
load_GL_ARB_shader_storage_buffer_object(GLADloadproc load)
{
...
static void
load_GL_ARB_shader_subroutine(GLADloadproc load)
{
...
static void
load_GL_ARB_shading_language_include(GLADloadproc load)
{
...
static void
load_GL_ARB_sparse_buffer(GLADloadproc load)
{
...
static void
load_GL_ARB_sparse_texture(GLADloadproc load)
{
...
static void
load_GL_ARB_sync(GLADloadproc load)
{
...
static void
load_GL_ARB_tessellation_shader(GLADloadproc load)
{
...
static void
load_GL_ARB_texture_multisample(GLADloadproc load)
{
...
static void
load_GL_ARB_texture_storage(GLADloadproc load)
{
...
static void
load_GL_ARB_texture_storage_multisample(GLADloadproc load)
{
...
static void
load_GL_ARB_transform_feedback2(GLADloadproc load)
{
...
static void
load_GL_ARB_transform_feedback3(GLADloadproc load)
{
...
static void
load_GL_ARB_transform_feedback_instanced(GLADloadproc load)
{
...
static void
load_GL_ARB_transpose_matrix(GLADloadproc load)
{
...
static void
load_GL_ARB_uniform_buffer_object(GLADloadproc load)
{
...
static void
load_GL_ARB_vertex_array_object(GLADloadproc load)
{
...
static void
load_GL_ARB_vertex_attrib_64bit(GLADloadproc load)
{
...
static void
load_GL_ARB_vertex_attrib_binding(GLADloadproc load)
{
...
static void
load_GL_ARB_vertex_blend(GLADloadproc load)
{
...
static void
load_GL_ARB_vertex_buffer_object(GLADloadproc load)
{
...
static void
load_GL_ARB_vertex_program(GLADloadproc load)
{
...
static void
load_GL_ARB_vertex_shader(GLADloadproc load)
{
...
static void
load_GL_ARB_vertex_type_2_10_10_10_rev(GLADloadproc load)
{
...
static void
load_GL_ARB_viewport_array(GLADloadproc load)
{
...
static void
load_GL_ARB_window_pos(GLADloadproc load)
{
...
static void
load_GL_ATI_envmap_bumpmap(GLADloadproc load)
{
...
static void
load_GL_ATI_fragment_shader(GLADloadproc load)
{
...
static void
load_GL_ATI_map_object_buffer(GLADloadproc load)
{
...
static void
load_GL_ATI_pn_triangles(GLADloadproc load)
{
...
static void
load_GL_ATI_separate_stencil(GLADloadproc load)
{
...
static void
load_GL_ATI_vertex_array_object(GLADloadproc load)
{
...
static void
load_GL_ATI_vertex_attrib_array_object(GLADloadproc load)
{
...
static void
load_GL_ATI_vertex_streams(GLADloadproc load)
{
...
static void
load_GL_EXT_EGL_image_storage(GLADloadproc load)
{
...
static void
load_GL_EXT_bindable_uniform(GLADloadproc load)
{
...
static void
load_GL_EXT_blend_func_separate(GLADloadproc load)
{
...
static void
load_GL_EXT_compiled_vertex_array(GLADloadproc load)
{
...
static void
load_GL_EXT_convolution(GLADloadproc load)
{
...
static void
load_GL_EXT_coordinate_frame(GLADloadproc load)
{
...
static void
load_GL_EXT_copy_texture(GLADloadproc load)
{
...
static void
load_GL_EXT_cull_vertex(GLADloadproc load)
{
...
static void
load_GL_EXT_debug_label(GLADloadproc load)
{
...
static void
load_GL_EXT_debug_marker(GLADloadproc load)
{
...
static void
load_GL_EXT_draw_buffers2(GLADloadproc load)
{
...
static void
load_GL_EXT_draw_instanced(GLADloadproc load)
{
...
static void
load_GL_EXT_draw_range_elements(GLADloadproc load)
{
...
static void
load_GL_EXT_external_buffer(GLADloadproc load)
{
...
static void
load_GL_EXT_fog_coord(GLADloadproc load)
{
...
static void
load_GL_EXT_framebuffer_blit(GLADloadproc load)
{
    if (!GLAD_GL_EXT_framebuffer_blit) return;
    glad_glBlitFramebufferEXT = (PFNGLBLITFRAMEBUFFEREXTPROC)load("glBlitFramebufferEXT");
}
static void
load_GL_EXT_framebuffer_blit_layers(GLADloadproc load)
{
...
static void
load_GL_EXT_framebuffer_multisample(GLADloadproc load)
{
...
static void
load_GL_EXT_framebuffer_object(GLADloadproc load)
{
...
static void
load_GL_EXT_geometry_shader4(GLADloadproc load)
{
...
static void
load_GL_EXT_gpu_program_parameters(GLADloadproc load)
{
...
static void
load_GL_EXT_gpu_shader4(GLADloadproc load)
{
...
static void
load_GL_EXT_histogram(GLADloadproc load)
{
...
static void
load_GL_EXT_memory_object(GLADloadproc load)
{
...
static void
load_GL_EXT_multi_draw_arrays(GLADloadproc load)
{
...
static void
load_GL_EXT_multisample(GLADloadproc load)
{
...
static void
load_GL_EXT_paletted_texture(GLADloadproc load)
{
...
static void
load_GL_EXT_pixel_transform(GLADloadproc load)
{
...
static void
load_GL_EXT_point_parameters(GLADloadproc load)
{
...
static void
load_GL_EXT_semaphore(GLADloadproc load)
{
...
static void
load_GL_EXT_separate_shader_objects(GLADloadproc load)
{
...
static void
load_GL_EXT_shader_image_load_store(GLADloadproc load)
{
...
static void
load_GL_EXT_subtexture(GLADloadproc load)
{
...
static void
load_GL_EXT_texture3D(GLADloadproc load)
{
...
static void
load_GL_EXT_texture_array(GLADloadproc load)
{
...
static void
load_GL_EXT_texture_object(GLADloadproc load)
{
...
static void
load_GL_EXT_timer_query(GLADloadproc load)
{
...
static void
load_GL_EXT_transform_feedback(GLADloadproc load)
{
...
static void
load_GL_EXT_vertex_array(GLADloadproc load)
{
...
static void
load_GL_EXT_vertex_attrib_64bit(GLADloadproc load)
{
...
static void
load_GL_EXT_vertex_shader(GLADloadproc load)
{
...
static void
load_GL_EXT_vertex_weighting(GLADloadproc load)
{
...
static void
load_GL_EXT_win32_keyed_mutex(GLADloadproc load)
{
...
static void
load_GL_EXT_window_rectangles(GLADloadproc load)
{
...
static void
load_GL_GREMEDY_string_marker(GLADloadproc load)
{
...
static void
load_GL_HP_image_transform(GLADloadproc load)
{
...
static void
load_GL_IBM_multimode_draw_arrays(GLADloadproc load)
{
...
static void
load_GL_INGR_blend_func_separate(GLADloadproc load)
{
...
static void
load_GL_INTEL_framebuffer_CMAA(GLADloadproc load)
{
...
static void
load_GL_INTEL_map_texture(GLADloadproc load)
{
...
static void
load_GL_INTEL_parallel_arrays(GLADloadproc load)
{
...
static void
load_GL_INTEL_performance_query(GLADloadproc load)
{
...
static void
load_GL_KHR_parallel_shader_compile(GLADloadproc load)
{
...
static void
load_GL_KHR_robustness(GLADloadproc load)
{
...
static void
load_GL_MESA_framebuffer_flip_y(GLADloadproc load)
{
...
static void
load_GL_NVX_conditional_render(GLADloadproc load)
{
...
static void
load_GL_NVX_gpu_multicast2(GLADloadproc load)
{
...
static void
load_GL_NVX_linked_gpu_multicast(GLADloadproc load)
{
...
static void
load_GL_NVX_progress_fence(GLADloadproc load)
{
...
static void
load_GL_NV_alpha_to_coverage_dither_control(GLADloadproc load)
{
...
static void
load_GL_NV_bindless_multi_draw_indirect(GLADloadproc load)
{
...
static void
load_GL_NV_bindless_multi_draw_indirect_count(GLADloadproc load)
{
...
static void
load_GL_NV_bindless_texture(GLADloadproc load)
{
...
static void
load_GL_NV_blend_equation_advanced(GLADloadproc load)
{
...
static void
load_GL_NV_clip_space_w_scaling(GLADloadproc load)
{
...
static void
load_GL_NV_command_list(GLADloadproc load)
{
...
static void
load_GL_NV_conditional_render(GLADloadproc load)
{
...
static void
load_GL_NV_conservative_raster(GLADloadproc load)
{
...
static void
load_GL_NV_conservative_raster_dilate(GLADloadproc load)
{
...
static void
load_GL_NV_evaluators(GLADloadproc load)
{
...
static void
load_GL_NV_explicit_multisample(GLADloadproc load)
{
...
static void
load_GL_NV_fence(GLADloadproc load)
{
...
static void
load_GL_NV_fragment_coverage_to_color(GLADloadproc load)
{
...
static void
load_GL_NV_fragment_program(GLADloadproc load)
{
...
static void
load_GL_NV_framebuffer_mixed_samples(GLADloadproc load)
{
...
static void
load_GL_NV_framebuffer_multisample_coverage(GLADloadproc load)
{
...
static void
load_GL_NV_geometry_program4(GLADloadproc load)
{
...
static void
load_GL_NV_gpu_multicast(GLADloadproc load)
{
...
static void
load_GL_NV_gpu_program4(GLADloadproc load)
{
...
static void
load_GL_NV_gpu_program5(GLADloadproc load)
{
...
static void
load_GL_NV_gpu_shader5(GLADloadproc load)
{
...
static void
load_GL_NV_half_float(GLADloadproc load)
{
...
static void
load_GL_NV_internalformat_sample_query(GLADloadproc load)
{
...
static void
load_GL_NV_memory_attachment(GLADloadproc load)
{
...
static void
load_GL_NV_memory_object_sparse(GLADloadproc load)
{
...
static void
load_GL_NV_mesh_shader(GLADloadproc load)
{
...
static void
load_GL_NV_occlusion_query(GLADloadproc load)
{
...
static void
load_GL_NV_parameter_buffer_object(GLADloadproc load)
{
...
static void
load_GL_NV_path_rendering(GLADloadproc load)
{
...
static void
load_GL_NV_pixel_data_range(GLADloadproc load)
{
...
static void
load_GL_NV_point_sprite(GLADloadproc load)
{
...
static void
load_GL_NV_present_video(GLADloadproc load)
{
...
static void
load_GL_NV_primitive_restart(GLADloadproc load)
{
...
static void
load_GL_NV_register_combiners(GLADloadproc load)
{
...
static void
load_GL_NV_register_combiners2(GLADloadproc load)
{
...
static void
load_GL_NV_sample_locations(GLADloadproc load)
{
...
static void
load_GL_NV_scissor_exclusive(GLADloadproc load)
{
...
static void
load_GL_NV_shader_buffer_load(GLADloadproc load)
{
...
static void
load_GL_NV_shading_rate_image(GLADloadproc load)
{
...
static void
load_GL_NV_timeline_semaphore(GLADloadproc load)
{
...
static void
load_GL_NV_transform_feedback(GLADloadproc load)
{
...
static void
load_GL_NV_transform_feedback2(GLADloadproc load)
{
...
static void
load_GL_NV_vdpau_interop(GLADloadproc load)
{
...
static void
load_GL_NV_vdpau_interop2(GLADloadproc load)
{
...
static void
load_GL_NV_vertex_array_range(GLADloadproc load)
{
...
static void
load_GL_NV_vertex_attrib_integer_64bit(GLADloadproc load)
{
...
static void
load_GL_NV_vertex_buffer_unified_memory(GLADloadproc load)
{
...
static void
load_GL_NV_vertex_program(GLADloadproc load)
{
...
static void
load_GL_NV_vertex_program4(GLADloadproc load)
{
...
static void
load_GL_NV_video_capture(GLADloadproc load)
{
...
static void
load_GL_OES_fixed_point(GLADloadproc load)
{
...
static void
load_GL_OVR_multiview(GLADloadproc load)
{
...
static void
load_GL_PGI_misc_hints(GLADloadproc load)
{
    if (!GLAD_GL_PGI_misc_hints) return;
    glad_glHintPGI = (PFNGLHINTPGIPROC)load("glHintPGI");
}
static void
load_GL_SGIS_detail_texture(GLADloadproc load)
{
...
static void
load_GL_SGIS_fog_function(GLADloadproc load)
{
...
static void
load_GL_SGIS_multisample(GLADloadproc load)
{
...
static void
load_GL_SGIS_pixel_texture(GLADloadproc load)
{
...
static void
load_GL_SGIS_point_parameters(GLADloadproc load)
{
...
static void
load_GL_SGIS_sharpen_texture(GLADloadproc load)
{
...
static void
load_GL_SGIS_texture4D(GLADloadproc load)
{
...
static void
load_GL_SGIS_texture_color_mask(GLADloadproc load)
{
...
static void
load_GL_SGIS_texture_filter4(GLADloadproc load)
{
...
static void
load_GL_SGIX_async(GLADloadproc load)
{
...
static void
load_GL_SGIX_list_priority(GLADloadproc load)
{
...
static void
load_GL_SGIX_tag_sample_buffer(GLADloadproc load)
{
...
static void
load_GL_SGI_color_table(GLADloadproc load)
{
...
static void
load_GL_SUN_vertex(GLADloadproc load)
{
